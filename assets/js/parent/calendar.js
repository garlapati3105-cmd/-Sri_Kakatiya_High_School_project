// ============================================================
//  Sri Kakatiya School Management Platform – parent/calendar.js
...
(function () {
  ...
  function renderCalendar() {
    ...
    if (currentMonthEvents.length === 0) {
      agendaList.innerHTML = `<p style="text-align: center; color: var(--portal-text-muted);">No events scheduled.</p>`;
      return;
    }
    ...
    currentMonthEvents.forEach(e => {
      ...
      item.innerHTML = `
        ...
        <div style="font-size: 0.75rem; color: var(--portal-text-muted); margin-top: 0.25rem;">${e.startDate || e.start_date}</div>
        <div style="font-size: 0.8rem; margin-top: 0.5rem;">${e.description}</div>
      `;
